...
class compbio_abinitio; // forward declaration
typedef utility::pointer::owning_ptr< compbio_abinitio > compbio_abinitioOP;

class compbio_abinitio : public protocols::abinitio::Protocol
{
    enum StageID
    {
        ALL_STAGES = 0,
...
private:
    ...
    void output_models();
    void generate_extended_pose( core::pose::Pose & pose, std::string const & seq)  const;
    ...
    void process_decoy( core::pose::Pose & pose, core::scoring::ScoreFunction const & scorefxn,
    ...
    // # of cycles to be performed by  Monte Carlo in 5 stages
    core::Size num_cycles_stage1_;
    core::Size num_cycles_stage2_;
    core::Size num_cycles_stage3_;
    core::Size num_cycles_stage4_;
    core::Size num_cycles_stage5_;
    ...
    protocols::simple_moves::FragmentMoverOP brute_move_small_;
    protocols::simple_moves::FragmentMoverOP brute_move_large_;
    protocols::simple_moves::FragmentMoverOP smooth_move_small_;
...
typedef utility::pointer::owning_ptr< compbio_convergence_check > compbio_convergence_checkOP;

class compbio_convergence_check : public protocols::moves::PoseCondition
{
public:
    compbio_convergence_check()
        : bInit_( false ), ct_( 0 )
    {
    }
